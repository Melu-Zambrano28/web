...
public class ServicePartitaDao {
  ...
  /*  public ArrayList<Partita> listaPartita() throws SQLException, ClassNotFoundException {
    ...
    private static Partita mappaturaPartita(ResultSet result) throws SQLException, ClassNotFoundException {
        ...
        p.setSquadra_home(ServiceSquadraDao.selectSquadra(result.getInt("id_sq_home")));
        p.setSquadra_visitor(ServiceSquadraDao.selectSquadra(result.getInt("id_sq_visitor")));
        p.setGol_home(result.getInt("goal_sq_home"));
        p.setGol_visitor(result.getInt("goal_sq_visitor"));
